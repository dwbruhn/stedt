...
\makeatletter
\patchcmd{\chapter}{\if@openright\cleardoublepage\else\cleardoublepage\fi}{}{}{}
\makeatother
...
\fancyhead[RO]{\Large{Sino-Tibetan Etymological} \vspace{0.5em}}
\fancyhead[LE]{\Large{Dictionary and Thesaurus} \vspace{0.5em}}

\fancyhead[RE]{\Large{\leftmark} \vspace{0.5em}}
\fancyhead[LO]{\Large{\rightmark} \vspace{0.5em}}
...
\addcontentsline{toc}{chapter}{Protogloss Index}
