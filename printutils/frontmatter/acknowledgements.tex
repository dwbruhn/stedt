...
\item \textsc{Dai} Qingxia | Batang, Daofu, Gazhuo, Jiarong, \& Xixia
\item \textsc{Dai} Qingxia | Axi Yi, Hani, Nusu, \& Sani*
...
\item Martine Mazaudon | Tamangic languages
\item Boyd Michailovsky | Kiranti languages \& Proto-Kiranti
\item Alexis Michaud | Yonging Na \& Laze
\item Dinkapar Moral | Boro, Garo, Koch, \& Tintekiya Koch*
\item David Mortensen | Tankghulic languages \& Sorbung
...
\item Daya Ratna Shakya and David Hargreaves | Newar
...
\item \textsc{Sun} Hongkai | Bodic, rGyalrongic, Qiangic, Nungic, and ``North Assam" languages
\item \textsc{Sun} Hongkai | Xumi (Shixing)*
\item Tabu Taid | Mising*
\item T. Temsunungsang | Chungli Ao \& Mongsen Ao
\item \textsc{Tian} Desheng | Tujia*
\item \textsc{Toba} Sueyoshi and Allen Kom | Kom Rem
\item Kenneth VanBik | Kuki-Chin languages
\item Nienu Vikuosa | Angami, Chokri, \& Lotha
\item \textsc{Wang} Erson | Hanoi*
\item David \& Nancy Watters | Kham
\item \textsc{Xu} Xijian | Zaiwa*
\item Shiro Yabu | Khezha
\item \textsc{Zhao} Yansun | Bai
\end{itemize}

XYZ finish table of data contributors
