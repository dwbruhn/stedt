...
The importance of data contributors cannot be overstated, and STEDT would like to express the deepest gratitude to the many linguists, native speakers, and other individuals who advanced the project by contributing lexical and/or etymological data to the database. Below is a list of some of these contributors in no particular order. (Some contributors have no doubt been inadvertently missed, and we apologize for any omissions.)

\begin{supertabular}{l l}
\textit{Name} & \textit{Contribution(s)}\\
Philip \& Cecilia Brassett & Tujia\\
Helga Hartmann-So & Southern Chin languages\\
Robbins Burling & Garo\\
Ross Caughley & Chepang\\
Alec Coupe & Mongsen Ao\\
Jonathan Evans & Southern Qiang languages\\
Mark Post et al. & Galo\\
\textsc{Huziwara} Keisuke & Sak \& Marma\\
Randy Lapolla & Rawang \& Dulong\\
François Jacquesson & Deori\\
Tej Ratna Kansakar & Baram\\
Ken Manson & Kayan\\
Alexis Michaud & Yonging Na \& Laze\\
Jamin Pelkey & Phula languages\\
Heleen Plaisier & Lepcha\\
Roland Rutgers & Yamphu\\
\textsc{Shintani} Tadahiko & Pyen\\
T. Temsunungsang & Chungli Ao \& Mongsen Ao\\
Kenneth VanBik & Kuki-Chin languages\\
Daniel Bruhn & Central Naga languages\\
Seino van Breugel & Atong\\
David Mortensen & Tankghulic languages \& Sorbung\\
Theraphan Luangthongkum & Karenic languages\\
\textsc{Nagano} Yasuhiko et al. & rGyalrongic languages\\
Naomi Bishop & Sherpa Helambu\\
Sri Chhimed Bodh & Spiti Tibetan\\
Carol Genetti & Newar\\
Chen Kang & Tujia\\
Ch.\ Yashwanta Singh & Meithei\\
David Bradley & Ugong\\
Donald Kosha & Moyon\\
David \& Nancy Waters & Kham\\
\textsc{Dai} Qingxia & Batang, Daofu, Gazhuo, Jiarong, \& Xixia\\
\textsc{Luo} Meizhen & Ahi\\
Michael Ferlus & Phunoi\\
Martine Mazaudon & Tamangic languages\\
Michael Noonan et al. & Chantyal\\
Thien Haokip & Thado\\
N.\ Achumi & Sumi\\
Suhnu Ram Sharma & Bunan \& Manchati\\
Daya Ratna Shakya and David Hargreaves & Newar\\
\textsc{Sun} Hongkai & Bodic, rGyalrongic, Qiangic, Nungic, and ``North Assam" languages\\
Shiro Yabu & Khezha\\
\textsc{Toba} Sueyoshi and Allen Kom & Kom Rem\\
Tamara Kohn & Yakha\\
Nienu Vikuosa & Angami, Chokri, \& Lotha\\
\textsc{Zhao} Yansun & Bai\\
\end{supertabular}

XYZ finish table of data contributors; sort alphabetically; mention others who sent data but we didn't import? what about those whose data was digitized by STEDT? XYZ
