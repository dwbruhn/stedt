...
\tikzset{level 2/.style={level distance=48pt}}
\Tree [.Sino-Tibetan [ {NE India Areal Group} Sal Himalayish Tangut-Qiang Nungish Lolo-Burmese-Naxi Karenic Tujia Baic ].Tibeto-Burman Chinese ]
\end{tikzpicture}
\caption{Updated subgrouping model of ST/TB relationships XYZ UNFINISHED}
\label{fig:ST_tree}
\end{figure}
