...
perl -i -pe 's/Rix, Helmut and Kümmel, Martin and Zehnder, Thomas and Lipp, Reiner and Schirmer/Rix, Helmut and Kümmel, Martin and Zehnder, Thomas and Lipp, Reiner and Schirmer, Brigitte/' srcbib.csv
